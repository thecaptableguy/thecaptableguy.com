	...
	<body>
		...
		<header class="navbar bg-base-100 border-b border-base-300">
			...
			<nav class="navbar-end">
				<a href="#contact" class="btn btn-outline btn-accent btn-sm font-bold">Free Consultation</a>
			</nav>
		</header>
		...
		<main>
					...
					<div class="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
						<div class="text-center lg:text-left">
							...
							<p class="text-lg mb-6 text-base-content/80">
								Your Cap Table specialist with 15+ years of experience helping startups
								structure their equity properly from day one.
							</p>

							<div class="space-y-4">
								<div class="flex items-center gap-3">
									<div class="badge badge-outline badge-accent">✓</div>
									<span class="text-base-content">Former VP Finance at 3 successful exits</span>
								</div>
								<div class="flex items-center gap-3">
									<div class="badge badge-outline badge-accent">✓</div>
									<span class="text-base-content">500+ companies structured successfully</span>
								</div>
								<div class="flex items-center gap-3">
									<div class="badge badge-outline badge-accent">✓</div>
								...
								<div class="flex items-center gap-3">
									<div class="badge badge-outline badge-accent">✓</div>
									<span class="text-base-content">Stanford MBA & Certified CPA</span>
								</div>
							</div>
						</div>
						...
						<div class="text-center">
							<div class="avatar">
								<div class="w-80 rounded-full">
									<img src="/static/BobGillespieHeadshot.webp" class="object-cover" alt="Bob Gillespie" />
								</div>
							</div>
							<div class="mt-6">
								...
								<div class="text-center">
									<div class="badge badge-outline badge-primary border-primary/30 text-primary">CPA
										Certified</div>
									<div class="badge badge-outline badge-primary border-primary/30 text-primary ml-2">
										Finance MBA</div>
									<div class="badge badge-outline badge-primary border-primary/30 text-primary ml-2">
										15+
										Years</div>
			...
			<!-- Contact Section -->
			<div id="message" class="bg-primary text-primary-content py-20">
